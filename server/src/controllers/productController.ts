...
export async function createProduct(
  ...
  try {
    ...
    if (!name || !sku || !category || unit_price == null || !supplier_id) {
      throw createError("name, sku, category, unit_price, and supplier_id are required", 400);
    }
...
// Orders and alerts that reference this product remain intact and auditable.
